...
const torus = new THREE.Mesh(new THREE.TetrahedronGeometry(11,4,20,100),new THREE.MeshLambertMaterial({color: 0xcccccc, wireframe:true, wireframeLinewidth: 10, dithering: true}))

const heart = new THREE.Mesh(new THREE.TetrahedronGeometry(7,4),new THREE.MeshLambertMaterial({color: 0xcccccc, wireframe:true, wireframeLinewidth: 10, dithering: true}))

const heart2 = new THREE.Mesh(new THREE.TetrahedronGeometry(4,4),new THREE.MeshLambertMaterial({color: 0xcccccc, wireframe:true, wireframeLinewidth: 10, dithering: true}))


const beginning = new THREE.Mesh(new THREE.SphereGeometry(1,4),new THREE.MeshLambertMaterial({color: 0xCCCCCC, wireframe:true, wireframeLinewidth: 10, dithering: true}))
...
function animate(){
  ...
  for (let i = 2;i < array.length;i+=3)
  {
    array[i]= array[i]+Math.cos(rad);//THREE.MathUtils.randFloatSpread(0.5);
  }
